...
CKEDITOR.dialog.add("textfield", function (b) {
    function e(a) {
        var a = a.element, c = this.getValue();
    ...
    return{title: b.lang.forms.textfield.title, minWidth: 350, minHeight: 150, onShow: function () {
        ...
        var a = this.getParentEditor(), c = this.textField, b = !c;
        ...
        {id: "info", label: b.lang.forms.textfield.title, title: b.lang.forms.textfield.title,
            elements: [
                {type: "hbox", widths: ["50%", "50%"], children: [
                    {id: "_cke_saved_name", type: "text", label: b.lang.forms.textfield.name, "default": "", accessKey: "N", setup: function (a) {
                ...
                {id: "type", type: "select", label: b.lang.forms.textfield.type, "default": "text", accessKey: "M", items: [
