...
class UserCompany(User):
    class Meta:
        ...
        db_table = "Distribusi | Akun Perusahaan"
...
class Company(models.Model):
    ...
    position = models.CharField(verbose_name=_('Jabatan '), max_length=50, blank=True,
    ...
    business = models.CharField(verbose_name=_('Kegiatan Bisnis '), max_length=50, choices=BISNIS)
    industry = models.CharField(verbose_name=_('Bidang Industri '), max_length=50, choices=INDUSTRI)
    type = models.CharField(verbose_name=_('Jenis Perusahaan '), max_length=50, choices=TYPE_BISNIS)
    ...
    region = models.CharField(verbose_name=_('Regional'), max_length=50, choices=REGION, blank=True, null=True)
    country = models.CharField(verbose_name=_('Negara '), max_length=50, choices=[(x[0], x[3]) for x in COUNTRIES])
    city = models.CharField(verbose_name=_('Kota '), max_length=50, blank=True)
    province = models.CharField(verbose_name=_('Provinsi '), max_length=50, blank=True)
    npwp = models.CharField(verbose_name=_('N.P.W.P '), max_length=50, blank=True,
    ...
    """
    currency = models.ForeignKey(Currency, verbose_name=_('Mata Uang '), blank=True, null=True,
                                 help_text="*) Mata uang yang digunakan.")
    bank_name = models.ForeignKey(Bank, verbose_name=_('Nama Bank '), blank=True, null=True)
    bank_branch = models.CharField(verbose_name=_('Cabang '), max_length=50, blank=True,
                                   help_text=_('*) ex: Jakarta, Surabaya, others.'))
    bank_account_name = models.CharField(verbose_name=_('Atas Nama '), max_length=50, blank=True,
                                         help_text=_('*) Nama lengkap dalam rekening.'))
    rek = models.CharField(verbose_name=_('No. Rekening '), max_length=50, blank=True,
    ...
    class Meta:
        ...
        db_table = "Distribusi | Data Perusahaan"
