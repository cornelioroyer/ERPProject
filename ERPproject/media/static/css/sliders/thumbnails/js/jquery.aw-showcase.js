...
(function (jQuery) {
    ...
    jQuery.fn.awShowcase = function (options) {
        ...
        if (options.thumbnails) {
            ...
            if (options.thumbnails_direction === 'horizontal') {
                thumb_restriction.css({'float': 'left'});
            }
                ...
                if ((id > current_id && direction !== 'previous') || direction === 'next') {
                    ...
                    if (options.viewline) {
                        ...
                        if (current_id < content_count - 1) {
                            ...
                            content_container.animate({left: animation_distance + 'px'}, options.transition_speed, function () {
                                animating = false;
                            });

                            // Change current content id (if content is finished)
                            if (jQuery('.showcase-arrow-next').is(':visible')) {
                                current_id++;
                            }
                        ...
                        if (options.transition === 'hslide') {
                            ...
                            jQuery(obj).delay(delay).animate({ left: -(options.content_width) }, options.transition_speed + options.transition_delay, function () {
                                obj.remove();
                            });
                        }
                        else if (options.transition === 'vslide') {

                            jQuery(obj).delay(delay).animate({ top: -(options.content_height) }, options.transition_speed + options.transition_delay, function () {
                                obj.remove();
                            });
                        }
                        else {
                ...
                // If we want to display the previous content
                    ...
                    if (options.viewline) {
                        ...
                        if (current_id !== 0) {
                            ...
                            content_container.animate({left: old_animation_distance + 'px'}, options.transition_speed, function () {
                                animating = false;
                            });
                            ...
                            if (current_id === 0) {
                                jQuery('.showcase-arrow-previous').fadeOut(300);
                            }
        ...
        function afterAnimation(obj) {
            if (options.dynamic_height) {
                content_container.stop(true, true).animate({ height: obj.find('.showcase-content').children().height() }, 200);
            }
            animating = false;
        ...
        function slideThumbnailWrapper(direction, check, backwardforward) {
            ...
            if (direction === 'forward' && doTheSlide) {
                ...
                if (options.thumbnails_direction === 'horizontal') {
                    ...
                    thumb_wrapper.animate({ top: thumbnailSlidePosition }, 300);
                }
            }
            else if (doTheSlide) {
