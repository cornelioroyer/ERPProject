(function (a) {
    a.suggest = function (o, g) {
        ...
        function j() {
            var e = c.offset();
            f.css({top: (e.top + o.offsetHeight) + "px", left: e.left + "px"})
        }
        ...
        function b(e, z) {
            var w = [], A = e.split(g.delimiter), y, x;
