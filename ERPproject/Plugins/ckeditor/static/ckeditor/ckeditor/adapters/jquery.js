...
(function (a) {
    ...
    "undefined" != typeof a && (a.extend(a.fn, {ckeditorGet: function () {
        ...
        this.each(function () {
            var b =
                a(this), c = b.data("ckeditorInstance"), f = b.data("_ckeditorInstanceLock"), h = this, j = new a.Deferred;
            i.push(j.promise());
            if (c && !f)g && g.apply(c, [this]), j.resolve(); else if (f)c.once("instanceReady", function () {
                setTimeout(function () {
        ...
        a.when.apply(this, i).then(function () {
            f.resolve()
        });
