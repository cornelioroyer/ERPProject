...
CKEDITOR.dialog.add("specialchar", function (i) {
    ...
    return{title: l.title, minWidth: 430, minHeight: 280, buttons: [CKEDITOR.dialog.cancelButton], charColumns: 17, onLoad: function () {
            ...
            {type: "hbox", align: "top", widths: ["320px", "90px"], children: [
                ...
                {type: "hbox", align: "top", widths: ["100%"], children: [
                    {type: "vbox",
                        ...
                        {type: "html", id: "charPreview", className: "cke_dark_background", style: "border:1px solid #eeeeee;font-size:28px;height:40px;width:70px;padding-top:9px;font-family:'Microsoft Sans Serif',Arial,Helvetica,Verdana;text-align:center;", html: "<div>&nbsp;</div>"},
