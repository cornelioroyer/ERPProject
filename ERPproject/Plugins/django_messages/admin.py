...
from Plugins.suit.widgets import SuitSplitDateTimeWidget
...
class MessageAdminForm(forms.ModelForm):
    ...
    class Meta:
        model = Message
        widgets = {
            'sent_at': SuitSplitDateTimeWidget,
            'read_at': SuitSplitDateTimeWidget,
            'replied_at': SuitSplitDateTimeWidget,
            'sender_deleted_at': SuitSplitDateTimeWidget,
            'recipient_deleted_at': SuitSplitDateTimeWidget,
        }
