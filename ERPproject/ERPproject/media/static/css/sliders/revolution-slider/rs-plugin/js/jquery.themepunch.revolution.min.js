...
(function (e, t) {
    ...
    function g(e, n, r) {
        ...
        var c = 0;
        var h = 0;
        if (n.sloth > n.slotw)h = n.sloth; else h = n.slotw;
        if (!r) {
            var c = 0 - h
        }
        n.slotw = h;
    ...
    function w(n, r) {
        ...
        var l = 0;
        if (u.data("transition") == "boxslide")l = 0; else if (u.data("transition") == "boxfade")l = 1; else if (u.data("transition") == "slotslide-horizontal")l = 2; else if (u.data("transition") == "slotslide-vertical")l = 3; else if (u.data("transition") == "curtain-1")l = 4; else if (u.data("transition") == "curtain-2")l = 5; else if (u.data("transition") == "curtain-3")l = 6; else if (u.data("transition") == "slotzoom-horizontal")l = 7; else if (u.data("transition") == "slotzoom-vertical")l = 8; else if (u.data("transition") == "slotfade-horizontal")l = 9; else if (u.data("transition") == "slotfade-vertical")l = 10; else if (u.data("transition") == "fade")l = 11; else if (u.data("transition") == "slideleft")l = 12; else if (u.data("transition") == "slideup")l = 13; else if (u.data("transition") == "slidedown")l = 14; else if (u.data("transition") == "slideright")l = 15; else if (u.data("transition") == "papercut")l = 16; else if (u.data("transition") == "3dcurtain-horizontal")l = 17; else if (u.data("transition") == "3dcurtain-vertical")l = 18; else if (u.data("transition") == "cubic")l = 19; else if (u.data("transition") == "flyin")l = 20; else if (u.data("transition") == "turnoff")l = 21; else {
                ...
                setTimeout(function () {
                    s.transition({top: 0, left: 0, scale: 1, rotate: 0}, h * 1.5, function () {
                        if (t == r.slots * r.slots - 1) {
                            ...
                            if (u.index() != i.index())a.find(".defaultimg").css({opacity: 0});
                            r.act = r.next;
                            o(n)
                        }
                    })
        ...
        if (l == 2) {
            ...
            f.find(".slotslide").each(function () {
                ...
                t.transit({left: "0px", rotate: 0}, h, function () {
                    ...
                    f.find(".defaultimg").css({opacity: 1});
                    if (u.index() != i.index())a.find(".defaultimg").css({opacity: 0});
                    if (r.ie)a.find(".defaultimg").css({opacity: 1});
                    r.act = r.next;
                    o(n)
                })
            })
        ...
        if (l == 11) {
            ...
            f.find(".slotslide").each(function (t) {
                var n = e(this);
                p++;
                if (r.ie9 || r.ie)n.transition({opacity: 0}, 0); else n.transition({opacity: 0, rotate: r.rotate}, 0);
        ...
        if (l == 12 || l == 13 || l == 14 || l == 15) {
            ...
            if (l == 12)if (r.ie9)w.transition({left: d + "px"}, 0); else w.transition({left: d + "px", rotate: r.rotate}, 0); else if (l == 15)if (r.ie9)w.transition({left: 0 - r.width + "px"}, 0); else w.transition({left: 0 - r.width + "px", rotate: r.rotate}, 0); else if (l == 13)if (r.ie9)w.transition({top: b + "px"}, 0); else w.transition({top: b + "px", rotate: r.rotate}, 0); else if (l == 14)if (r.ie9)w.transition({top: 0 - r.height + "px"}, 0); else w.transition({top: 0 - r.height + "px", rotate: r.rotate}, 0);
            ...
            if (l == 12)E.transition({left: 0 - d + "px", opacity: 1, rotate: 0}, h); else if (l == 15)E.transition({left: d + "px", opacity: 1, rotate: 0}, h); else if (l == 13)E.transition({top: 0 - b + "px", opacity: 1, rotate: 0}, h); else if (l == 14)E.transition({top: b + "px", opacity: 1, rotate: 0}, h)
        }
        if (l == 16) {
            ...
            if (!e.support.transition) {
                ...
                if (i.html() != null)u.transition({scale: .8, x: r.width * .1, y: r.height * .1, rotate: N}, 0).transition({rotate: 0, scale: 1, x: 0, y: 0}, 600, "snap")
            }
            f.find(".defaultimg").css({opacity: 1});
            setTimeout(function () {
        ...
        if (l == 19) {
            ...
            f.find(".slotslide").each(function (t) {
                ...
                if (c == 1)s.transition({opacity: 0, left: 0, top: r.height / 2, perspective: r.height * 100, rotate3d: "1, 0, 0, -90deg "}, 0); else s.transition({opacity: 0, left: 0, top: 0 - r.height / 2, perspective: r.height * 100, rotate3d: "1, 0, 0, 90deg "}, 0);
                setTimeout(function () {
            ...
            a.find(".slotslide").each(function (t) {
                ...
                a.find(".defaultimg").css({opacity: 0});
                setTimeout(function () {
                    if (c == 1)n.transition({opacity: .6, left: 0, top: 0 - r.height / 2, rotate3d: "1, 0, 0, 90deg"}, h * 2, function () {
                    }); else n.transition({opacity: .6, left: 0, top: 0 + r.height / 2, rotate3d: "1, 0, 0, -90deg"}, h * 2, function () {
                    })
                }, t * 150)
            })
        }
        if (l == 20) {
            ...
            f.find(".slotslide").each(function (t) {
                var s = e(this);
                s.parent().css({overflow: "visible"});
                if (c == 1)s.transition({scale: .8, top: 0, left: 0 - r.width, perspective: r.width, rotate3d: "2, 5, 0, 110deg"}, 0); else s.transition({scale: .8, top: 0, left: 0 + r.width, perspective: r.width, rotate3d: "2, 5, 0, -110deg"}, 0);
                setTimeout(function () {
            ...
            a.find(".slotslide").each(function (t) {
                ...
                a.find(".defaultimg").css({opacity: 0});
                setTimeout(function () {
                    if (c == 1)n.transition({top: 0, left: r.width / 2, perspective: r.width, rotate3d: "0, -3, 0, 70deg", opacity: 0}, h * 2, "out", function () {
                    }); else n.transition({top: 0, left: 0 - r.width / 2, perspective: r.width, rotate3d: "0, -3, 0, -70deg", opacity: 0}, h * 2, "out", function () {
                    })
                }, t * 100)
            })
        }
        if (l == 21) {
            ...
            f.find(".slotslide").each(function (t) {
                var s = e(this);
                if (c == 1)s.transition({top: 0, left: 0 - r.width / 2, perspective: r.width * 2, rotate3d: "0, 100, 0, 90deg"}, 0); else s.transition({top: 0, left: 0 + r.width / 2, perspective: r.width * 2, rotate3d: "0, 100, 0, -90deg"}, 0);
                setTimeout(function () {
            ...
            a.find(".slotslide").each(function (t) {
                ...
                a.find(".defaultimg").css({opacity: 0});
                setTimeout(function () {
                    if (c == 1)n.transition({top: 0, left: r.width / 2, perspective: r.width, rotate3d: "0, 1000, 0, -90deg"}, h * 1.5, function () {
                    }); else n.transition({top: 0, left: 0 - r.width / 2, perspective: r.width, rotate3d: "0, 1000, 0, +90deg"}, h * 1.5, function () {
                    })
                }, t * 100)
            })
        }
    ...
    function S(t) {
        if (t.data == YT.PlayerState.PLAYING) {
            ...
            var n = e("body").find(".tp-bannertimer");
            var r = n.data("opt");
            if (r.conthover == 0)n.animate({width: "100%"}, {duration: r.delay - r.cd - 100, queue: false, easing: "linear"});
            r.videoplaying = false;
            r.videostoppednow = 1
        }
    }
        ...
        n.find(".tp-caption").each(function (i) {
            ...
            if (a == 0) {
                        ...
                        if (n.attr("src").toLowerCase().indexOf("youtube") >= 0) {
                            if (!n.hasClass("HasListener")) {
                                try {
                                    n.attr("id", l);
                                    var r;
                                    if (u.data("autoplay") == true)r = new YT.Player(l, {events: {onStateChange: S, onReady: x}}); else r = new YT.Player(l, {events: {onStateChange: S}});
                            ...
                            if (n.attr("src").toLowerCase().indexOf("vimeo") >= 0) {
                                if (!n.hasClass("HasListener")) {
                                    ...
                                    if (u.data("autoplay") == true)$f(r).addEvent("ready", C); else $f(r).addEvent("ready", N)
                                }
                            }
                        }
                    })
                ...
                if (u.hasClass("randomrotate")) {
                    ...
                    if (r.ie || r.ie9) {
                    } else u.transition({scale: 1, rotate: 0})
                }
                if (u.hasClass("lfr")) {
    ...
    function A(e, n) {
        ...
        if (e.hasClass("ltr") || e.hasClass("ltl") || e.hasClass("str") || e.hasClass("stl") || e.hasClass("ltt") || e.hasClass("ltb") || e.hasClass("stt") || e.hasClass("stb")) {
            i = e.position().left;
            s = e.position().top;
            if (e.hasClass("ltr"))i = n.width + 20; else if (e.hasClass("ltl"))i = 0 - e.width() - 20; else if (e.hasClass("ltt"))s = 0 - e.height() - 20; else if (e.hasClass("ltb"))s = n.height + 20; else if (e.hasClass("str")) {
                i = i + 50;
                o = 0
            ...
            if (e.hasClass("lfr"))i = n.width + 20; else if (e.hasClass("lfl"))i = 0 - e.width() - 20; else if (e.hasClass("lft"))s = 0 - e.height() - 20; else if (e.hasClass("lfb"))s = n.height + 20;
            var u = e.data("endeasing");
            if (u == t)u = "linear";
            e.animate({opacity: o, left: i + "px", top: s + "px"}, {duration: e.data("endspeed"), easing: u});
            if (n.ie)e.addClass("noFilterClass")
    ...
    function O(e, n) {
        n.cd = 0;
        n.loop = 0;
        if (n.stopAfterLoops != t && n.stopAfterLoops > -1)n.looptogo = n.stopAfterLoops; else n.looptogo = 9999999;
        if (n.stopAtSlide != t && n.stopAtSlide > -1)n.lastslidetoshow = n.stopAtSlide; else n.lastslidetoshow = 999;
        ...
        if (n.slideamount > 1 && !(n.stopAfterLoops == 0 && n.stopAtSlide == 1)) {
            ...
            n.cdint = setInterval(function () {
                ...
                if (n.fullWidth != "on")if (n.width > n.hideSliderAtLimit)e.parent().removeClass("tp-hide-revslider"); else e.parent().addClass("tp-hide-revslider");
