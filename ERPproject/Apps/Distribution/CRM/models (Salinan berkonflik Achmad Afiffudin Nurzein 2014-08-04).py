...
class Contacts(models.Model):
    name = models.CharField(verbose_name=_('Nama Lengkap '), max_length=100)
    email = models.EmailField(verbose_name=_('E-mail  '))
    phone = models.CharField(verbose_name=_('Telepon '), max_length=15)
    company = models.CharField(verbose_name=_('Perusahaan '), max_length=100,
...
class News(models.Model):
    title = models.CharField(verbose_name=_('Judul'), max_length=100)
...
class Complaint(models.Model):
    ...
    title = models.CharField(verbose_name=_("Judul Komplain "), max_length=100)
    about = models.CharField(verbose_name=_("Jenis Komplain "), max_length=100, choices=ABOUT_COMPLAINT)
    status = models.CharField(verbose_name=_("Status "), choices=COMPLAINT_STATUS, default=1, max_length=100)
